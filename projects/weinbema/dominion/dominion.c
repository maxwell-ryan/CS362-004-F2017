...
//refactored card #2
int executeAdventurer(int currentPlayer, struct gameState *state) {
...
//refactored card #5
int executeGreat_hall(int currentPlayer, struct gameState *state, int handPos) {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case adventurer:
      ...
      //this card has been refactored into its own func
      return executeAdventurer(currentPlayer, state);
    ...
    case smithy:
      ...
      //this card has been refactored into its own func
      return executeSmithy(currentPlayer, state, handPos);

    case village:

      //this card has been refactored into its own func
      return executeVillage(currentPlayer, state, handPos);
    ...
    case great_hall:
      ...
      //this card has been refactored into its own func
      return executeGreat_hall(currentPlayer, state, handPos);
    ...
    case cutpurse:
      ...
      //this card has been refactored into its own func
      return executeCutpurse(currentPlayer, state, handPos);
